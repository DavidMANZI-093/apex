        ...
        <div className="relative w-full flex container !mx-auto !px-4 sm:!px-6 lg:!px-8">
            <div className="relative grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative flex">
                    <div className="relative bg-url('/placeholder.png') bg-cover bg-center w-full h-fit bg-gradient-to-br from-verdigris/20 to-tiffany-blue/20 rounded-2xl flex items-center justify-center">
                    ...
                    </div>
                </div>
            </div>
