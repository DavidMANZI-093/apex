	...
	return (
		<button
			className={
				props.className
					? props.className
					: `flex items-center justify-center gap-2 !py-2 !px-4 !rounded-lg !text-[15px] !font-medium transition-colors duration-200 active:!bg-slate-gray cursor-pointer ${props.variant === "outline" ? "!border-[1.5px] !border-slate-gray hover:!border-transparent bg-transparent !text-slate-gray hover:!bg-indigo-dye/70 hover:!text-white" : props.variant === "gold" ? "!bg-dutch-white/90 hover:!bg-dutch-white/85 !text-indigo-dye/90" : "!bg-slate-gray hover:!bg-indigo-dye/70 !text-white"}`
			}
